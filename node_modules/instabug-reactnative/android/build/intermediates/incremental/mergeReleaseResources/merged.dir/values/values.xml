...
<resources xmlns:ns1="urn:oasis:names:tc:xliff:document:1.2" xmlns:ns2="http://schemas.android.com/tools">
    <string-array name="ibg_bug_annotation_colors_names_content_description">
        <item>Red color</item>
        <item>Green color</item>
        <item>Purple color</item>
        <item>Blue color</item>
        <item>Orange color</item>
        <item>Yellow color</item>
        <item>Grey color</item>
    </string-array>
    ...
    <attr format="color|reference" name="ib_annotation_color_picker_bg_color"/>
    <attr format="color|reference" name="ib_core_alert_dialog_msg_color"/>
    <attr format="color|reference" name="ib_core_attachment_item_text_color"/>
    <attr format="color|reference" name="ib_core_attr_onboarding_color_sub_title"/>
    <attr format="color|reference" name="ib_core_attr_onboarding_color_title"/>
    <attr format="color" name="ib_core_color_dialog_item_description"/>
    <attr format="color" name="ib_fr_add_comment_edit_text_underline_color"/>
    <attr format="color" name="ib_fr_details_add_feature_tv_color"/>
    <attr format="color" name="ib_fr_details_comments_status_separator_color"/>
    <attr format="color" name="ib_fr_details_comments_tv_color"/>
    <attr format="color" name="ib_fr_details_date"/>
    <attr format="color" name="ib_fr_details_owner"/>
    <attr format="color" name="ib_fr_details_subtitle"/>
    <attr format="color" name="ib_fr_details_title"/>
    <attr format="color" name="ib_fr_no_comments_icon_color"/>
    <attr format="color" name="ib_fr_no_comments_txt_color"/>
    <attr format="color" name="ib_fr_seprator_color"/>
    <attr format="color" name="ib_fr_str_add_comment_disclaimer"/>
    <attr format="color" name="ib_fr_thanks_title_color"/>
    <attr format="color|reference" name="ibg_bug_add_attachment_icon_color"/>
    <attr format="color|reference" name="ibg_bug_alert_dialog_msg_color"/>
    <attr format="color|reference" name="ibg_bug_attachment_background_color"/>
    <attr format="color|reference" name="ibg_bug_attachment_border_color"/>
    <attr format="color|reference" name="ibg_bug_color_bg_pbi"/>
    <attr format="color|reference" name="ibg_bug_seperator_color"/>
    <attr format="color|reference" name="ibg_bug_thanks_bg_color"/>
    <attr format="color|reference" name="ibg_bug_thanks_subtitle_color"/>
    <attr format="color|reference" name="ibg_bug_vus_empty_state_label_color"/>
    <attr format="color|reference" name="ibg_bug_vus_header_text_color"/>
    <attr format="color|reference" name="ibg_bug_vus_item_subtitle_color"/>
    <attr format="color|reference" name="ibg_bug_vus_item_title_color"/>
    <attr format="color|reference" name="ibg_bug_vus_separator_color"/>
    <attr format="color|reference" name="instabug_attachment_bg_icon_color"/>
    <attr format="color|reference" name="instabug_background_color"/>
    <attr format="color" name="instabug_dialog_button_text_color"/>
    <attr format="color" name="instabug_dialog_item_text_color"/>
    <attr format="reference" name="instabug_divider"/>
    <attr format="color" name="instabug_divider_color"/>
    <attr format="color|reference" name="instabug_foreground_color"/>
    <attr format="color|reference" name="instabug_fr_pbi_footer_text_color"/>
    <attr format="color|reference" name="instabug_fr_text_color"/>
    <attr format="reference" name="instabug_item_border"/>
    <attr format="color" name="instabug_message_date_text_color"/>
    <attr format="color" name="instabug_message_sender_text_color"/>
    <attr format="color" name="instabug_message_snippet_text_color"/>
    <attr format="color|reference" name="instabug_primary_color"/>
    <attr format="color|reference" name="instabug_received_message_text_color"/>
    <attr format="color|reference" name="instabug_sent_message_text_color"/>
    <attr format="reference" name="instabug_survey_dialog_footer_transition"/>
    <attr format="reference" name="instabug_survey_dialog_header_transition"/>
    <attr format="color" name="instabug_survey_edittext_color"/>
    <attr format="color|reference" name="instabug_survey_mcq_radio_icon_color"/>
    <attr format="color|reference" name="instabug_survey_mcq_text_color"/>
    <attr format="color|reference" name="instabug_survey_mcq_text_color_selected"/>
    <attr format="color|reference" name="instabug_survey_mcq_unselected_bg"/>
    <attr format="color|reference" name="instabug_survey_question_color"/>
    <attr format="color|reference" name="instabug_survey_welcome_dismiss_txt_color"/>
    <attr format="color|reference" name="instabug_survey_welcome_msg_color"/>
    <attr format="color|reference" name="instabug_survey_welcome_title_color"/>
    <attr format="color|reference" name="instabug_theme_hint_text_color"/>
    <attr format="color|reference" name="instabug_theme_tinting_color"/>
    <attr format="color" name="instabug_unread_message_background_color"/>
    ...
    <attr format="reference" name="survey_container_bg"/>
    <attr format="reference" name="survey_edittext_background"/>
    <attr format="color|reference" name="survey_nps_background_color"/>
    <attr format="color|reference" name="survey_nps_circles_color"/>
    <attr format="color|reference" name="survey_nps_circles_container_background"/>
    <attr format="color|reference" name="survey_nps_circles_container_border_background"/>
    <attr format="color|reference" name="survey_nps_numbers_color"/>
    <attr format="color|reference" name="survey_welcome_subtitle_color"/>
    ...
    <color name="dark_theme_status_bar_color">#0a0a0a</color>
    ...
    <color name="ib_bug_separator_color_dark">#8e8e93</color>
    <color name="ib_bug_separator_color_light">#e6e6e6</color>
    <color name="ib_bug_vus_empty_state_label_color_dark">#DEFFFFFF</color>
    <color name="ib_bug_vus_empty_state_label_color_light">#DE000000</color>
    <color name="ib_bug_vus_header_text_color_dark">#ffffff</color>
    <color name="ib_bug_vus_header_text_color_light">#212121</color>
    <color name="ib_bug_vus_item_subtitle_color_dark">#8Affffff</color>
    <color name="ib_bug_vus_item_subtitle_color_light">#8A000000</color>
    <color name="ib_bug_vus_item_title_color_dark">#DEffffff</color>
    <color name="ib_bug_vus_item_title_color_light">#DE000000</color>
    <color name="ib_core_annotation_tinting_color">#9e9e9e</color>
    <color name="ib_core_notification_dot_color">#c53a41</color>
    <color name="ib_fr_add_comment_edit_text_underline_color_default_dark">#4c4c4c</color>
    <color name="ib_fr_add_comment_edit_text_underline_color_default_light">#cccccc</color>
    <color name="ib_fr_add_comment_error">#F41337</color>
    <color name="ib_fr_colorAccent">#295dfd</color>
    <color name="ib_fr_colorPrimary">#3F51B5</color>
    <color name="ib_fr_colorPrimaryDark">#3F51B5</color>
    <color name="ib_fr_color_completed">#57D99B</color>
    <color name="ib_fr_color_dimmed_state">#c8ffffff</color>
    <color name="ib_fr_color_highlight">#F2FF00</color>
    <color name="ib_fr_color_in_progress">#FF7E00</color>
    <color name="ib_fr_color_maybe_later">#A7A7A7</color>
    <color name="ib_fr_color_opened">#98BDFF</color>
    <color name="ib_fr_color_ordinary_state">#ffffff</color>
    <color name="ib_fr_color_planned">#C27DFF</color>
    <color name="ib_fr_color_ptr_loading_txt">#808080</color>
    <color name="ib_fr_details_add_feature_tv_color_dark">#6c6c6d</color>
    <color name="ib_fr_details_add_feature_tv_color_light">#909090</color>
    <color name="ib_fr_details_comments_status_change_light">#B6B4B4</color>
    <color name="ib_fr_details_comments_status_separator_color_dark">#4E4E4E</color>
    <color name="ib_fr_details_comments_status_separator_color_light">#e6e6e6</color>
    <color name="ib_fr_details_comments_tv_color_dark">#808080</color>
    <color name="ib_fr_details_comments_tv_color_light">#898989</color>
    <color name="ib_fr_details_date_dark">#808080</color>
    <color name="ib_fr_details_date_light">#BFBFBF</color>
    <color name="ib_fr_details_owner_dark">#808080</color>
    <color name="ib_fr_details_owner_light">#808080</color>
    <color name="ib_fr_details_subtitle_color_dark">#7F7F7F</color>
    <color name="ib_fr_details_subtitle_color_light">#808080</color>
    <color name="ib_fr_details_title_color_dark">#CCCCCC</color>
    <color name="ib_fr_details_title_color_light">#333333</color>
    <color name="ib_fr_new_feature_toast_bg">#4D4D4D</color>
    <color name="ib_fr_no_comments_icon_color_dark">#424242</color>
    <color name="ib_fr_no_comments_icon_color_light">#e6e6e6</color>
    <color name="ib_fr_no_comments_txt_color_dark">#4d4d4d</color>
    <color name="ib_fr_no_comments_txt_color_light">#BFBFBF</color>
    <color name="ib_fr_pbi_color">#525E6C</color>
    <color name="ib_fr_ripple_color">#ffffff</color>
    <color name="ib_fr_seprator_color_dark">#404040</color>
    <color name="ib_fr_seprator_color_light">#e6e6e6</color>
    <color name="ib_fr_str_add_comment_disclaimer_dark">#666666</color>
    <color name="ib_fr_str_add_comment_disclaimer_light">#EEEEEE</color>
    <color name="ib_fr_str_add_comment_disclaimer_txt_color">#A9A9A9</color>
    <color name="ib_fr_thanks_title_color_dark">#8f8f8f</color>
    <color name="ib_fr_thanks_title_color_light">#6b6b6b</color>
    <color name="ib_fr_toolbar_dark_color">#212121</color>
    <color name="ib_fr_toolbar_vote_btn_stroke_color">#1b000000</color>
    <color name="ib_fr_vote_text_dark">#c1c1c1</color>
    <color name="ib_fr_vote_text_light_color">#808080</color>
    <color name="ib_fr_white">#FFFFFF</color>
    <color name="instabug_annotation_color_blue">#2d8cd5</color>
    <color name="instabug_annotation_color_default">@color/instabug_annotation_color_red</color>
    <color name="instabug_annotation_color_gray">#273646</color>
    <color name="instabug_annotation_color_green">#00a388</color>
    <color name="instabug_annotation_color_red">#e16152</color>
    <color name="instabug_annotation_color_yellow">#efca4c</color>
    <color name="instabug_attachment_bar_color_dark">#212121</color>
    <color name="instabug_color_survey_separator">#0D000000</color>
    <color name="instabug_color_text_grey_light">#FFA5A5A5</color>
    <color name="instabug_dark_theme_hint_text_color">#888888</color>
    <color name="instabug_dialog_bg_color">#90000000</color>
    <color name="instabug_dialog_dark_bg_color">#363636</color>
    <color name="instabug_extrafield_error">#C5291C</color>
    <color name="instabug_grey_hint_dark">#4E4E4E</color>
    <color name="instabug_grey_hint_light">#DCDBDC</color>
    <color name="instabug_light_theme_hint_text_color">#ACACAC</color>
    <color name="instabug_survey_back_icon_color">#C6C6C6</color>
    <color name="instabug_survey_pbi_color">#525E6C</color>
    <color name="instabug_survey_txt_color_grey">#B1B1B1</color>
    <color name="instabug_text_color_grey">#737373</color>
    <color name="instabug_text_color_light_grey">#898989</color>
    <color name="instabug_theme_tinting_color_dark">#fdfdfd</color>
    <color name="instabug_theme_tinting_color_light">#737373</color>
    <color name="instabug_toolbar_color_dark">#212121</color>
    <color name="instabug_transparent_color">#00000000</color>
    <color name="instabug_url_color_blue">#365899</color>
    <color name="light_theme_status_bar_color">#c5c6c7</color>
    ...
    <color name="nps_background_dark">#363636</color>
    <color name="nps_background_light">#FFFFFF</color>
    <color name="nps_circles_dark">#3E3E3E</color>
    <color name="nps_circles_light">#D8D8D8</color>
    <color name="nps_circles_rect_background_dark">#4D4D4D</color>
    <color name="nps_circles_rect_background_light">#F9F9F9</color>
    <color name="nps_circles_rect_border_dark">#4D4D4D</color>
    <color name="nps_circles_rect_border_light">#ECECEC</color>
    <color name="nps_numbers_dark">#AEAEAE</color>
    <color name="nps_numbers_light">#99000000</color>
    ...
    <color name="survey_btn_disabled_color_dark">#5F5F5F</color>
    <color name="survey_btn_disabled_color_light">#D9D9D9</color>
    <color name="survey_btn_txt_color_dark">#888888</color>
    <color name="survey_edittext_background">#F8FAFB</color>
    <color name="survey_edittext_background_dark">#4D4D4D</color>
    <color name="survey_mcq_unselected_dark">#AEAEAE</color>
    <color name="survey_mcq_unselected_light">#D8D8D8</color>
    <color name="survey_nps_txt_bg_color_dark">#565656</color>
    <color name="survey_nps_txt_color_dark">#C7C7C7</color>
    <color name="survey_nps_txt_color_light">#B5B5B5</color>
    <color name="survey_rate_selected">#F8E71C</color>
    <color name="survey_rate_star_border">@android:color/transparent</color>
    <color name="survey_rate_unselected_dark">#515151</color>
    <color name="survey_rate_unselected_light">#E6E6E6</color>
    <color name="survey_txt_color_dark">#EFEFEF</color>
    <color name="survey_txt_color_light">#B3000000</color>
    <color name="surveys_nps_box_color_white">#F3F3F3</color>
    ...
    <color name="welcome_screen_subtitle_dark">#EFEFEF</color>
    <color name="welcome_screen_subtitle_light">#B3747474</color>
    <dimen name="Instabug_text_medium">18sp</dimen>
    ...
    <dimen name="ib_bug_attachemnt_icon_size">24dp</dimen>
    <dimen name="ib_bug_vus_item_delete_margin">20dp</dimen>
    <dimen name="ib_bug_vus_item_screenshot_size">65dp</dimen>
    <dimen name="ib_bug_vus_item_title_margin">16dp</dimen>
    <dimen name="ib_chat_padding_touchable_target_default">16dp</dimen>
    <dimen name="ib_core_dialog_item_margin_left">16dp</dimen>
    <dimen name="ib_core_dialog_item_margin_right">10dp</dimen>
    <dimen name="ib_core_dialog_width_default">400dp</dimen>
    <dimen name="ib_core_dimen_16">16dp</dimen>
    <dimen name="ib_core_dimen_8">8dp</dimen>
    <dimen name="ib_core_margin_right_prompt_option_icon_default">16dp</dimen>
    <dimen name="ib_core_margin_top_prompt_option_icon">4dp</dimen>
    <dimen name="ib_core_onboarding_margin_sides">45dp</dimen>
    <dimen name="ib_core_padding_xsmall">8dp</dimen>
    <dimen name="ib_core_prompt_dialog_padding">30dp</dimen>
    <dimen name="ib_core_text_size_small">12sp</dimen>
    <dimen name="ib_dimen_bug_attachments_row_height">84dp</dimen>
    <dimen name="ib_dimen_bug_attachments_space_padding">24dp</dimen>
    <dimen name="ib_fr_add_comment_height">40dp</dimen>
    <dimen name="ib_fr_card_padding_left_right">16dp</dimen>
    <dimen name="ib_fr_comment_text_size">15sp</dimen>
    <dimen name="ib_fr_details_padding_bottom">@dimen/ib_fr_space_16</dimen>
    <dimen name="ib_fr_details_padding_top">@dimen/ib_fr_space_24</dimen>
    <dimen name="ib_fr_details_title_padding_left_right">@dimen/ib_fr_space_16</dimen>
    <dimen name="ib_fr_email_disclaimer_height">24dp</dimen>
    <dimen name="ib_fr_email_disclaimer_top_margin">0dp</dimen>
    <dimen name="ib_fr_space_12">12dp</dimen>
    <dimen name="ib_fr_space_16">16dp</dimen>
    <dimen name="ib_fr_space_2">2dp</dimen>
    <dimen name="ib_fr_space_20">20dp</dimen>
    <dimen name="ib_fr_space_24">24dp</dimen>
    <dimen name="ib_fr_space_36">36dp</dimen>
    <dimen name="ib_fr_space_4">4dp</dimen>
    <dimen name="ib_fr_space_8">8dp</dimen>
    <dimen name="ib_fr_toast_multi_line_padding">8dp</dimen>
    <dimen name="ib_fr_toast_single_line_padding">6dp</dimen>
    <dimen name="ib_fr_toast_text_size">14sp</dimen>
    <dimen name="ib_fr_user_avatar">32dp</dimen>
    <dimen name="ib_survey_thanks_dialog">218dp</dimen>
    <dimen name="ib_survey_thanks_subtitle">15sp</dimen>
    <dimen name="ib_survey_thanks_title">25sp</dimen>
    <dimen name="instabug_announcement_feature_description">18sp</dimen>
    <dimen name="instabug_announcement_feature_title">18sp</dimen>
    <dimen name="instabug_announcement_title">24sp</dimen>
    <dimen name="instabug_attachment_placeholder_margin">4dp</dimen>
    <dimen name="instabug_bottom_sheet_padding">8dp</dimen>
    <dimen name="instabug_button_text_size">12sp</dimen>
    <dimen name="instabug_chat_item_avatar_size">40dp</dimen>
    <dimen name="instabug_container_padding">16dp</dimen>
    <dimen name="instabug_date_text_size">10sp</dimen>
    <dimen name="instabug_dialog_container_padding">24dp</dimen>
    <dimen name="instabug_dialog_padding_left_right">24dp</dimen>
    <dimen name="instabug_dialog_padding_top_bottom">40dp</dimen>
    <dimen name="instabug_fab_actions_spacing">16dp</dimen>
    <dimen name="instabug_fab_circle_icon_size">14dp</dimen>
    <dimen name="instabug_fab_circle_icon_stroke">2dp</dimen>
    <dimen name="instabug_fab_distance">2dp</dimen>
    <dimen name="instabug_fab_icon_size_mini">18dp</dimen>
    <dimen name="instabug_fab_icon_size_normal">26dp</dimen>
    <dimen name="instabug_fab_labels_margin">8dp</dimen>
    <dimen name="instabug_fab_shadow_offset">3dp</dimen>
    <dimen name="instabug_fab_shadow_radius">9dp</dimen>
    <dimen name="instabug_fab_size_mini">42dp</dimen>
    <dimen name="instabug_fab_size_normal">60dp</dimen>
    <dimen name="instabug_fab_stroke_width">1dp</dimen>
    <dimen name="instabug_fab_text_size">16sp</dimen>
    <dimen name="instabug_normal_text_size">14sp</dimen>
    <dimen name="instabug_path_view_dimen">36dp</dimen>
    <dimen name="instabug_path_view_margin">4dp</dimen>
    <dimen name="instabug_question_text_size">16sp</dimen>
    <dimen name="instabug_remove_attachment_button_padding">8dp</dimen>
    <dimen name="instabug_remove_attachment_button_size">34dp</dimen>
    <dimen name="instabug_survey_container_padding">16dp</dimen>
    <dimen name="instabug_survey_dialog_padding_left_right">16dp</dimen>
    <dimen name="instabug_survey_dialog_padding_top_bottom">20dp</dimen>
    <dimen name="instabug_survey_pager_top_space">4dp</dimen>
    <dimen name="instabug_survey_pbi_text_size">10sp</dimen>
    <dimen name="instabug_survey_welcome_dialog_padding_left_right">40dp</dimen>
    <dimen name="instabug_toolbar_button_padding">18dp</dimen>
    <dimen name="instabug_vertical_separator_height">1dp</dimen>
    ...
    <dimen name="question_answer_text_height">120dp</dimen>
    ...
    <dimen name="survey_bottom_pdi_margin">30dp</dimen>
    <dimen name="survey_button_height">48dp</dimen>
    <dimen name="survey_button_margin_top">10dp</dimen>
    <dimen name="survey_button_text_size">16sp</dimen>
    <dimen name="survey_edittext_top_margin">16dp</dimen>
    <dimen name="survey_margin_left_right">24dp</dimen>
    <dimen name="survey_mcq_list_top_margin">16dp</dimen>
    <dimen name="survey_nps_height">100dp</dimen>
    <dimen name="survey_nps_likely_labels_size">13sp</dimen>
    <dimen name="survey_nps_likely_top_margin">8dp</dimen>
    <dimen name="survey_nps_selected_rect_size">36dp</dimen>
    <dimen name="survey_nps_selection_text_size">26sp</dimen>
    <dimen name="survey_nps_text_size">15sp</dimen>
    <dimen name="survey_nps_top_margin">-16dp</dimen>
    <dimen name="survey_question_text_size">13sp</dimen>
    <dimen name="survey_question_title">17sp</dimen>
    <dimen name="survey_question_top_margin">16dp</dimen>
    <dimen name="survey_rate_us_image_height">70dp</dimen>
    <dimen name="survey_rate_us_subTitle_text_size">16sp</dimen>
    <dimen name="survey_rate_us_title_text_size">25sp</dimen>
    <dimen name="survey_rating_bar_margin_top">24dp</dimen>
    <dimen name="survey_star_margin_top">24dp</dimen>
    <dimen name="survey_text_end_margin">40dp</dimen>
    <dimen name="survey_welcome_subtitle_text_margin_top">16dp</dimen>
    <dimen name="survey_welcome_subtitle_text_size">14sp</dimen>
    <dimen name="survey_welcome_title_text_size">22sp</dimen>
    ...
    <item name="TAG_BTN_BACK" type="id"/>
    <item name="TAG_BTN_CLOSE" type="id"/>
    ...
    <item name="instabug_decor_view" type="id"/>
    <item name="instabug_extra_screenshot_button" type="id"/>
    <item name="instabug_fab_container" type="id"/>
    <item name="instabug_fab_expand_menu_button" type="id"/>
    <item name="instabug_fab_label" type="id"/>
    <item name="instabug_floating_button" type="id"/>
    <item name="instabug_in_app_notification" type="id"/>
    <item name="instabug_intro_dialog" type="id"/>
    <item name="instabug_video_mute_button" type="id"/>
    <item name="instabug_video_stop_button" type="id"/>
    ...
    <integer name="ib_anim_slide_duration">300</integer>
    <integer name="instabug_icon_lang_rotation">0</integer>
    ...
    <plurals name="instabug_feature_rq_str_days_ago">
        <item quantity="one">%d day ago</item>
        <item quantity="other">%d days ago</item>
    </plurals>
    <plurals name="instabug_feature_rq_str_hours_ago">
        <item quantity="one">%d hr ago</item>
        <item quantity="other">%d hrs ago</item>
    </plurals>
    <plurals name="instabug_feature_rq_str_minutes_ago">
        <item quantity="one">%d min ago</item>
        <item quantity="other">%d mins ago</item>
    </plurals>
    <string name="IBGAskQuestionHint">Ask us anything.</string>
    <string name="IBGPromptOptionsReportBug">Report a bug</string>
    <string name="IBGReportBugHint">Please be as detailed as possible. What did you expect and what happened instead?</string>
    <string name="IBGReproStepsDisclaimerBody">To help us fix the problem, your report will include a list of steps to reproduce the issue.</string>
    <string name="IBGReproStepsDisclaimerLink">Edit list</string>
    <string name="IBGReproStepsListEmptyStateLabel">All app screens have been deleted.</string>
    <string name="IBGReproStepsListHeader">The list of app screens you visited will only be used to help us reproduce the problem you’re reporting.</string>
    <string name="IBGReproStepsListItemName">Screen #</string>
    <string name="IBGReproStepsListTitle">Visited Screens</string>
    <string name="IBGSuggestImprovementHint">How can we improve your experience using this app?</string>
    ...
    <string name="add_feature">Add your thoughts</string>
    <string name="alert_description" translatable="false">Alert</string>
    <string name="appbar_scrolling_view_behavior" translatable="false">com.google.android.material.appbar.AppBarLayout$ScrollingViewBehavior</string>
    <string name="askAQuestionHeader">Ask a question</string>
    ...
    <string name="feature_request_close_dialog_message">Are you sure you want to cancel?</string>
    <string name="feature_request_comments">Comments</string>
    <string name="feature_request_comments_count">%d Comments</string>
    <string name="feature_request_go_back">Back</string>
    <string name="feature_request_leave_comment">Be the first to leave a comment.</string>
    <string name="feature_request_owner">By %s</string>
    <string name="feature_request_owner_anonymous">By Anonymous</string>
    <string name="feature_request_owner_anonymous_word">Anonymous</string>
    <string name="feature_request_status_changed_to">Status changed to</string>
    <string name="feature_request_str_add_comment_comment_empty">Please enter a valid comment.</string>
    <string name="feature_request_str_add_comment_disclaimer">We will need your e-mail to keep you posted with the updates.</string>
    <string name="feature_request_str_add_comment_error">Something went wrong while trying to add your comment.</string>
    <string name="feature_request_str_add_comment_valid_email">Please enter a valid email address.</string>
    <string name="feature_request_str_add_feature_error">Something went wrong while trying to add your feature.</string>
    <string name="feature_request_str_adding_your_comment">Adding your comment</string>
    <string name="feature_request_str_just_now">Just Now</string>
    <string name="feature_request_str_less">Less</string>
    <string name="feature_request_str_more">More</string>
    <string name="feature_request_str_post_comment">Post</string>
    <string name="feature_request_str_thanks">Thanks for your feedback!</string>
    <string name="feature_request_str_thanks_msg">We will keep you posted with the updates</string>
    <string name="feature_request_votes_count">%d Votes</string>
    <string name="feature_requests_details">Feature Details</string>
    <string name="feature_requests_error_state_sub_title">Check your connection and try again.</string>
    <string name="feature_requests_error_state_title">Something went wrong.</string>
    <string name="feature_requests_new_adding_your_suggestion">Adding your suggestion.</string>
    <string name="feature_requests_new_appbar_title">Add Feature</string>
    <string name="feature_requests_new_bottom_hint">We will need your e-mail to keep you posted with the updates.</string>
    <string name="feature_requests_new_description">Description</string>
    <string name="feature_requests_new_email">Email</string>
    <string name="feature_requests_new_err_msg_email">please Enter a valid email</string>
    <string name="feature_requests_new_err_msg_required">Title field is required</string>
    <string name="feature_requests_new_name">Name</string>
    <string name="feature_requests_new_positive_button">Add</string>
    <string name="feature_requests_new_title">Title</string>
    <string name="feature_requests_new_toast_message">Make sure to write clear title and description.</string>
    <string name="features_rq_main_fragment_tab1">All</string>
    <string name="features_rq_main_fragment_tab2">Mine</string>
    ...
    <string name="ib_alert_phone_number_msg">Phone number is optional and will be used only for troubleshooting purposes as related to this issue.</string>
    <string name="ib_announcement_redirect_error">Unable to redirect to link</string>
    <string name="ib_bug_report_bug_description">Something in the app is broken or doesn’t work as expected</string>
    <string name="ib_bug_report_feedback_description">New ideas or desired enhancements for this app</string>
    <string name="ib_bug_report_question_description">Help, support, and other inquiries</string>
    <string name="ib_error_phone_number">Please enter a valid US phone number.</string>
    <string name="ib_feature_rq_status_completed">Completed</string>
    <string name="ib_feature_rq_status_inprogress">Started</string>
    <string name="ib_feature_rq_status_maybe_later">Maybe later</string>
    <string name="ib_feature_rq_status_open">Posted</string>
    <string name="ib_feature_rq_status_planned">Planned</string>
    <string name="ib_feature_rq_str_add_your_idea">Add Your Idea</string>
    <string name="ib_feature_rq_str_completed_features">%d Completed Features</string>
    <string name="ib_feature_rq_str_load_more_fail_txt">Failed, Can\'t load data</string>
    <string name="ib_feature_rq_str_load_more_loading_txt">Refreshing...</string>
    <string name="ib_feature_rq_str_no_ideas_are_added_yet">No ideas are added yet.</string>
    <string name="ib_feature_rq_str_no_results">No results found</string>
    <string name="ib_feature_rq_str_pull_to_refresh">Pull to refresh</string>
    <string name="ib_feature_rq_str_release_to_refresh">Release to refresh</string>
    <string name="ib_feature_rq_str_search">Search</string>
    <string name="ib_feature_rq_str_votes">Votes</string>
    <string name="ib_fr_request_feature_description">Post an idea for a new feature and vote on others</string>
    <string name="ib_hint_phone_number">Enter your phone number</string>
    <string name="ib_str_beta_done">Done</string>
    <string name="ib_str_beta_welcome_finishing_step_content">Stay on the latest version to have access to all the fixes and features.</string>
    <string name="ib_str_beta_welcome_finishing_step_title">Stay up to date.</string>
    <string name="ib_str_beta_welcome_how_to_report_step_content_floating">Tap on the floating button to report a problem or suggest an improvement.</string>
    <string name="ib_str_beta_welcome_how_to_report_step_content_screenshot">Take a screenshot to report a problem or suggest an improvement.</string>
    <string name="ib_str_beta_welcome_how_to_report_step_content_shake">Shake your device to report a problem or suggest an improvement.</string>
    <string name="ib_str_beta_welcome_how_to_report_step_content_swipe">Do a two finger swipe from right to left to report a bug or feedback.</string>
    <string name="ib_str_beta_welcome_how_to_report_step_title">How to report a bug?</string>
    <string name="ib_str_beta_welcome_step_content">Thank you for helping us improve our app. We are looking forward to your feedback and bug reports.</string>
    <string name="ib_str_beta_welcome_step_title">Welcome to our beta app</string>
    <string name="ib_str_live_welcome_message_title">We are always happy to hear your thoughts.</string>
    <string name="ib_str_report_data" translatable="false">Report data</string>
    <string name="ibg_ask_question_message_edit_text_content_description" translatable="false">Enter your question</string>
    <string name="ibg_bug_annotation_blur_content_description" translatable="false">Blur</string>
    <string name="ibg_bug_annotation_brush_content_description" translatable="false">Annotate</string>
    <string name="ibg_bug_annotation_magnify_content_description" translatable="false">Zoom</string>
    <string name="ibg_bug_annotation_original_shape_content_description" translatable="false">Drawn shape detection</string>
    <string name="ibg_bug_annotation_recognized_shape_content_description" translatable="false">Smooth Shape detection</string>
    <string name="ibg_bug_annotation_undo_content_description" translatable="false">Undo</string>
    <string name="ibg_bug_report_add_attachment_content_description" translatable="false">Add Attachment. You can take a Screen Recording, Screenshot or select image from Gallery</string>
    <string name="ibg_bug_report_arrow_handler_collapse_description" translatable="false">Collapse Attachments</string>
    <string name="ibg_bug_report_arrow_handler_expand_description" translatable="false">Expand Attachments</string>
    <string name="ibg_bug_report_attachment_edit_content_description" translatable="false">Edit</string>
    <string name="ibg_bug_report_attachment_remove_content_description" translatable="false">Remove screenshot</string>
    <string name="ibg_bug_report_discard_dialog_cancel_btn_description" translatable="false">Cancel discarding this report</string>
    <string name="ibg_bug_report_discard_dialog_discard_btn_description" translatable="false">Discard this report</string>
    <string name="ibg_bug_report_next_btn_content_description" translatable="false">Next button</string>
    <string name="ibg_bug_report_thanks_title_content_description" translatable="false">Your feedback has been sent.</string>
    <string name="ibg_bug_report_video_play_content_description" translatable="false">Play video</string>
    <string name="ibg_bug_report_visual_steps_disclaimer_action_description" translatable="false">edit screenshots list</string>
    <string name="ibg_bug_reporting_email_edit_text_content_description" translatable="false">Enter your email address</string>
    <string name="ibg_bug_reporting_email_edit_text_invalid_email_error_content_description" translatable="false">Invalid email</string>
    <string name="ibg_bug_reporting_message_edit_text_content_description" translatable="false">Describe the bug you faced. Add comments</string>
    <string name="ibg_bug_visited_screen_back_btn_content_description" translatable="false">Close list</string>
    <string name="ibg_bug_visited_screen_delete_btn_content_description" translatable="false">Delete screen</string>
    <string name="ibg_chat_add_attachment_btn_content_description" translatable="false">Add attachment</string>
    <string name="ibg_chat_back_to_conversations_btn_content_description" translatable="false">Back to conversations</string>
    <string name="ibg_chat_conversation_content_description" translatable="false">Conversation</string>
    <string name="ibg_chat_conversation_with_name_content_description" translatable="false">Conversation with %s</string>
    <string name="ibg_chat_send_message_btn_content_description" translatable="false">Send</string>
    <string name="ibg_chats_conversations_close_content_description" translatable="false">Close Conversations</string>
    <string name="ibg_chats_conversations_screen_content_description" translatable="false">Conversations</string>
    <string name="ibg_core_annotation_ic_close_content_description" translatable="false">Close screenshot editing</string>
    <string name="ibg_core_annotation_ic_done_content_description" translatable="false">Save Screenshot edits</string>
    <string name="ibg_core_extended_report_ic_close_content_description" translatable="false">Close the Extended Report and get back to report a problem page</string>
    <string name="ibg_core_ic_close_ask_question_content_description" translatable="false">Cancel question</string>
    <string name="ibg_core_ic_close_bug_report_content_description" translatable="false">Cancel bug report</string>
    <string name="ibg_core_ic_close_suggest_improvement_content_description" translatable="false">Cancel suggestion</string>
    <string name="ibg_extended_report_actual_results_edit_text_description" translatable="false">Enter the actual results</string>
    <string name="ibg_extended_report_expected_results_edit_text_description" translatable="false">Enter the expected results</string>
    <string name="ibg_extended_report_steps_to_reproduce_edit_text_description" translatable="false">Enter the steps needed to reproduce the issue</string>
    <string name="ibg_extra_screenshot_button_content_description" translatable="false">Take Screenshot</string>
    <string name="ibg_notification_dismiss_btn_content_description" translatable="false">Dismiss new message</string>
    <string name="ibg_notification_reply_btn_content_description" translatable="false">Reply to new message</string>
    <string name="ibg_prompt_options_list_view_scroll_description" translatable="false">Scroll down</string>
    <string name="ibg_prompt_options_notification_count_content_description" translatable="false">You have %d unread messages</string>
    <string name="ibg_prompt_options_title_content_description" translatable="false">Do you need help? Select one of the following options</string>
    <string name="ibg_question_send_content_description" translatable="false">Send Question</string>
    <string name="ibg_report_send_content_description" translatable="false">Send bug report</string>
    <string name="ibg_screen_recording_mute_btn_content_description" translatable="false">Mute the mic</string>
    <string name="ibg_screen_recording_notification_title">Screen recording is active</string>
    <string name="ibg_screen_recording_unmute_btn_content_description" translatable="false">Unmute the mic</string>
    <string name="ibg_scren_recording_duration_btn_content_description" translatable="false">Screen Recording Duration</string>
    <string name="ibg_scren_recording_stop_btn_content_description" translatable="false">Stop Screen Recording</string>
    <string name="ibg_suggest_improvement_message_edit_text_content_description" translatable="false">How can we improve your experience?</string>
    <string name="ibg_suggestion_send_content_description" translatable="false">Send Suggestion</string>
    ...
    <string name="instabug_alert_dialog_no">NO</string>
    <string name="instabug_alert_dialog_yes">YES</string>
    <string name="instabug_audio_recorder_permission_denied">Audio recording permission denied</string>
    <string name="instabug_custom_survey_thanks_subtitle">Your thoughts will influence better future updates.</string>
    <string name="instabug_custom_survey_thanks_title">Thank you!</string>
    <string name="instabug_err_invalid_comment">Please enter a valid comment</string>
    <string name="instabug_err_invalid_email">Please enter a valid email</string>
    <string name="instabug_err_invalid_extra_field">Missing Data: %1$s is required!</string>
    <string name="instabug_external_storage_permission_denied">Storage permission denied</string>
    <string name="instabug_store_rating_survey_thanks_subtitle">Your feedback will help us build a better app.</string>
    <string name="instabug_store_rating_survey_thanks_title">@string/instabug_custom_survey_thanks_title</string>
    <string name="instabug_str_action_submit">Submit</string>
    <string name="instabug_str_actual_results">Actual results</string>
    <string name="instabug_str_add_attachment">Add Attachment</string>
    <string name="instabug_str_add_photo">Select image from gallery</string>
    <string name="instabug_str_alert_message_max_attachments">Remove an existing attachment to add a new one.</string>
    <string name="instabug_str_alert_title_max_attachments">Cannot Add Attachment</string>
    <string name="instabug_str_annotate">Draw on screenshot</string>
    <string name="instabug_str_audio">Audio</string>
    <string name="instabug_str_bugreport_dismiss_cancel">Cancel</string>
    <string name="instabug_str_bugreport_dismiss_discard">Discard</string>
    <string name="instabug_str_bugreport_dismiss_warning_message">Are you sure you want to discard this report?</string>
    <string name="instabug_str_bugreport_dismiss_warning_title">Discard this report?</string>
    <string name="instabug_str_bugreport_file_size_limit_warning_message">Please upload a file less than %d MB</string>
    <string name="instabug_str_bugreport_file_size_limit_warning_title">File size is too big</string>
    <string name="instabug_str_cancel">Cancel</string>
    <string name="instabug_str_capturing_screenshot_error">Couldn\'t capture screenshot due to low memory</string>
    <string name="instabug_str_conversations">Conversations</string>
    <string name="instabug_str_dialog_message_preparing">Preparing…</string>
    <string name="instabug_str_dismiss">Dismiss</string>
    <string name="instabug_str_email_hint">Enter your email</string>
    <string name="instabug_str_empty" translatable="false"/>
    <string name="instabug_str_error_survey_without_answer">Survey cannot be submitted without an answer.</string>
    <string name="instabug_str_expected_results">Expected results</string>
    <string name="instabug_str_features_request_header">Feature Requests</string>
    <string name="instabug_str_features_request_ptr_loading_list_text">It delights us hearing your thoughts!</string>
    <string name="instabug_str_feedback_header">Suggest an improvement</string>
    <string name="instabug_str_hint_enter_your_answer">Enter your answer</string>
    <string name="instabug_str_hold_to_record">Press and Hold to Record</string>
    <string name="instabug_str_image">Image</string>
    <string name="instabug_str_image_loading_error">Couldn\'t load image</string>
    <string name="instabug_str_invocation_dialog_title">Need help?</string>
    <string name="instabug_str_messages">Messages</string>
    <string name="instabug_str_next" translatable="false">next</string>
    <string name="instabug_str_notification_title">"%1$s Team"</string>
    <string name="instabug_str_notifications_body">%1$d new messages from %2$s and others</string>
    <string name="instabug_str_ok">OK</string>
    <string name="instabug_str_pick_media_chooser_title">Select a file</string>
    <string name="instabug_str_pick_media_from_gallery">Select file from gallery</string>
    <string name="instabug_str_please_wait">Please wait a moment</string>
    <string name="instabug_str_plus" translatable="false">+</string>
    <string name="instabug_str_powered_by_instabug">Powered by Instabug</string>
    <string name="instabug_str_record_video">Take a screen recording</string>
    <string name="instabug_str_release_stop_record">Release to Attach</string>
    <string name="instabug_str_reply">Reply</string>
    <string name="instabug_str_request_feature">Request a feature</string>
    <string name="instabug_str_send" translatable="false">send</string>
    <string name="instabug_str_sending_message_hint">Type your message</string>
    <string name="instabug_str_shake_hint"><![CDATA[We love to hear your feedback<br/><b>Shake</b> your device to talk to us.]]></string>
    <string name="instabug_str_steps_to_reproduce">Steps to reproduce</string>
    <string name="instabug_str_success_note">We\'ve received your feedback.\nThank you for helping us make %s better.</string>
    <string name="instabug_str_survey_next">Next</string>
    <string name="instabug_str_swipe_hint"><![CDATA[We love to hear your feedback<br /><b>Swipe with 2 fingers</b> to talk to us.]]></string>
    <string name="instabug_str_take_screenshot">Take a screenshot</string>
    <string name="instabug_str_talk_to_us">Talk to us</string>
    <string name="instabug_str_thank_you">Thank you!</string>
    <string name="instabug_str_video">Video</string>
    <string name="instabug_str_video_encoder_busy">Video Encoder is busy encoding other video</string>
    <string name="instabug_str_video_encoding_error">Couldn\'t encode video due to low memory</string>
    <string name="instabug_str_video_length_limit_warning_message">Please upload a video that is less than 1 minute in duration.</string>
    <string name="instabug_str_video_length_limit_warning_title">Video duration is too long</string>
    <string name="instabug_str_video_player">Video Player</string>
    <string name="instabug_str_video_recording_hint">Press record when ready</string>
    <string name="instabug_survey_welcome_button">"Let's Go"</string>
    <string name="instabug_survey_welcome_feedback">"We’d love to hear from you"</string>
    <string name="instabug_survey_welcome_feedback_msg">Can you help us do better by filling this brief survey?</string>
    ...
    <string name="sort_by_recently_updated">Recent</string>
    <string name="sort_by_top_rated">Top</string>
    ...
    <string name="surveys_nps_btn_rate_us">Rate us on Play Store</string>
    <string name="surveys_nps_less_likely">Less Likely</string>
    <string name="surveys_nps_rate_us_message">Thanks for the love</string>
    <string name="surveys_nps_very_likely">Very Likely</string>
    ...
    <style name="AttachmentIcon">
        <item name="android:layout_width">@dimen/ib_bug_attachemnt_icon_size</item>
        <item name="android:layout_height">@dimen/ib_bug_attachemnt_icon_size</item>
    ...
    <style name="IbFrActionBar" parent="Widget.AppCompat.Light.ActionBar.Solid.Inverse">
        <item name="android:background">#FF0000</item>
    </style>
    <style name="IbFrAddCommentEditText">
        <item name="android:paddingTop">4dp</item>
        <item name="android:layout_width">match_parent</item>
        <item name="android:layout_height">wrap_content</item>
        <item name="android:background">@null</item>
        <item name="android:lineSpacingMultiplier">1.2</item>
        <item name="android:textSize">@dimen/ib_fr_comment_text_size</item>
    </style>
    <style name="IbFrAppTheme" parent="Theme.AppCompat.Light.DarkActionBar"/>
    <style name="IbFrAppTheme.NoActionBar">
        <item name="windowActionBar">false</item>
        <item name="windowNoTitle">true</item>
        <item name="colorPrimary">@color/ib_fr_colorPrimary</item>
        <item name="colorPrimaryDark">@color/ib_fr_colorPrimaryDark</item>
        <item name="colorAccent">@color/ib_fr_colorAccent</item>
        <item name="textAllCaps">false</item>
    </style>
    <style name="IbFrDark" parent="InstabugSdkTheme.Dark">
        <item name="ib_fr_details_title">@color/ib_fr_details_title_color_dark</item>
        <item name="ib_fr_details_subtitle">@color/ib_fr_details_subtitle_color_dark</item>
        <item name="ib_fr_details_date">@color/ib_fr_details_date_dark</item>
        <item name="ib_fr_details_owner">@color/ib_fr_details_owner_dark</item>
        <item name="ib_fr_details_add_feature_tv_color">@color/ib_fr_details_add_feature_tv_color_dark</item>
        <item name="ib_fr_seprator_color">@color/ib_fr_seprator_color_dark</item>
        <item name="ib_fr_no_comments_icon_color">@color/ib_fr_no_comments_icon_color_dark</item>
        <item name="ib_fr_no_comments_txt_color">@color/ib_fr_no_comments_txt_color_dark</item>
        <item name="ib_fr_details_comments_tv_color">@color/ib_fr_details_comments_tv_color_dark</item>
        <item name="ib_fr_details_comments_status_separator_color">@color/ib_fr_details_comments_status_separator_color_dark</item>
        <item name="ib_fr_add_comment_edit_text_underline_color">@color/ib_fr_add_comment_edit_text_underline_color_default_dark</item>
        <item name="ib_fr_str_add_comment_disclaimer">@color/ib_fr_str_add_comment_disclaimer_dark</item>
        <item name="ib_fr_thanks_title_color">@color/ib_fr_thanks_title_color_dark</item>
    </style>
    <style name="IbFrFeatureStatus">
        <item name="android:layout_marginLeft">8dp</item>
        <item name="android:layout_marginStart">8dp</item>
        <item name="android:layout_toEndOf">@id/ib_btn_fr_vote</item>
        <item name="android:layout_toRightOf">@+id/ib_btn_fr_vote</item>
        <item name="android:background">@drawable/ibg_fr_bg_status</item>
    ...
    <style name="IbFrLight" parent="InstabugSdkTheme.Light">
        <item name="ib_fr_details_title">@color/ib_fr_details_title_color_light</item>
        <item name="ib_fr_details_subtitle">@color/ib_fr_details_subtitle_color_light</item>
        <item name="ib_fr_details_date">@color/ib_fr_details_date_light</item>
        <item name="ib_fr_details_owner">@color/ib_fr_details_owner_light</item>
        <item name="ib_fr_details_add_feature_tv_color">@color/ib_fr_details_add_feature_tv_color_light</item>
        <item name="ib_fr_seprator_color">@color/ib_fr_seprator_color_light</item>
        <item name="ib_fr_no_comments_icon_color">@color/ib_fr_no_comments_icon_color_light</item>
        <item name="ib_fr_no_comments_txt_color">@color/ib_fr_no_comments_txt_color_light</item>
        <item name="ib_fr_details_comments_tv_color">@color/ib_fr_details_comments_tv_color_light</item>
        <item name="ib_fr_details_comments_status_separator_color">@color/ib_fr_details_comments_status_separator_color_light</item>
        <item name="ib_fr_add_comment_edit_text_underline_color">@color/ib_fr_add_comment_edit_text_underline_color_default_light</item>
        <item name="ib_fr_str_add_comment_disclaimer">@color/ib_fr_str_add_comment_disclaimer_light</item>
        <item name="ib_fr_thanks_title_color">@color/ib_fr_thanks_title_color_light</item>
    </style>
    <style name="IbFrPopupMenuOverlapAnchorDark" parent="@style/Theme.AppCompat">
    ...
    <style name="IbFrPopupMenuOverlapAnchorLight" parent="@style/Theme.AppCompat.Light">
        <item name="android:dropDownVerticalOffset">16dp</item>
        <item name="android:dropDownHorizontalOffset">-16dp</item>
        <item name="colorAccent">#5e5e5e</item>
    </style>
    <style name="IbFrToolbarContainer" parent="InstabugBaseToolbarContainer">
        <item name="android:layout_height">52dp</item>
    </style>
    <style name="IbFrToolbarVoteButton">
    ...
    <style name="InstabugAnnotationColorIconContainer">
        <item name="android:layout_width">wrap_content</item>
        <item name="android:layout_height">wrap_content</item>
    ...
    <style name="InstabugAnnotationColorIconImage">
        <item name="android:layout_width">36dp</item>
        <item name="android:layout_height">36dp</item>
        <item name="android:adjustViewBounds">true</item>
        <item name="android:scaleType">fitCenter</item>
    </style>
    <style name="InstabugAnnotationContainer" parent="InstabugBaseContainer">
        <item name="android:background">@android:color/transparent</item>
    </style>
    <style name="InstabugAnnouncementTitle" parent="InstabugBaseText">
        <item name="android:textSize">@dimen/instabug_announcement_title</item>
        <item name="android:textColor">?attr/colorPrimary</item>
        <item name="android:gravity">start</item>
        <item name="android:textStyle">bold</item>
        <item name="android:layout_marginRight">@dimen/survey_text_end_margin</item>
        <item name="android:layout_marginLeft">@dimen/instabug_dialog_container_padding</item>
        <item name="android:layout_marginTop">@dimen/instabug_dialog_container_padding</item>
        <item name="android:background">?attr/instabug_survey_dialog_header_transition</item>
        <item name="android:ellipsize">none</item>
        <item name="android:maxLines">4</item>
    </style>
    <style name="InstabugBaseContainer">
        <item name="android:layout_width">match_parent</item>
        <item name="android:layout_height">match_parent</item>
        <item name="android:background">?attr/instabug_background_color</item>
        <item name="android:layout_gravity">center_vertical</item>
        <item name="android:orientation">vertical</item>
        <item name="android:clickable">true</item>
    </style>
    <style name="InstabugBaseText">
        <item name="android:layout_width">match_parent</item>
        <item name="android:layout_height">wrap_content</item>
        <item name="android:gravity">center_vertical</item>
        <item name="android:textColor">?attr/instabug_foreground_color</item>
    </style>
    <style name="InstabugBaseToolbarContainer">
        <item name="android:layout_width">match_parent</item>
        <item name="android:layout_height">?android:attr/actionBarSize</item>
        <item name="android:background">?attr/instabug_primary_color</item>
    </style>
    <style name="InstabugBorderlessDialog" parent="android:Theme.Light">
        <item name="android:windowFrame">@null</item>
        <item name="android:windowIsFloating">true</item>
        <item name="android:windowContentOverlay">@null</item>
        <item name="android:windowAnimationStyle">@android:style/Animation.Dialog</item>
        <item name="android:windowBackground">@color/instabug_transparent_color</item>
        <item name="android:windowSoftInputMode">stateUnspecified|adjustPan</item>
        <item name="android:colorBackgroundCacheHint">@null</item>
    </style>
    <style name="InstabugBottomBarContainer">
        <item name="android:layout_width">match_parent</item>
        <item name="android:layout_height">wrap_content</item>
    ...
    <style name="InstabugBottomSheetContainer" parent="InstabugBaseContainer">
        <item name="android:layout_gravity">bottom</item>
        <item name="android:paddingLeft">@dimen/instabug_container_padding</item>
        <item name="android:paddingRight">@dimen/instabug_container_padding</item>
        <item name="android:paddingBottom">@dimen/instabug_bottom_sheet_padding</item>
    </style>
    <style name="InstabugBottomSheetItemBaseImage">
        <item name="android:layout_width">24dp</item>
        <item name="android:layout_height">24dp</item>
        <item name="android:gravity">center_vertical</item>
    </style>
    <style name="InstabugBottomSheetItemContainer">
        <item name="android:layout_width">match_parent</item>
        <item name="android:layout_height">48dp</item>
    </style>
    <style name="InstabugBottomSheetItemImage" parent="InstabugBottomSheetItemBaseImage">
        <item name="android:layout_gravity">center_vertical</item>
        <item name="android:padding">2dp</item>
    </style>
    <style name="InstabugBottomSheetItemText" parent="InstabugBaseText">
        <item name="android:layout_height">match_parent</item>
        <item name="android:textSize">@dimen/instabug_normal_text_size</item>
    </style>
    <style name="InstabugBugReportingDark" parent="InstabugSdkTheme.Dark">
        <item name="ibg_bug_add_attachment_icon_color">#666666</item>
        <item name="ib_core_attachment_item_text_color">#FFFFFF</item>
        <item name="ibg_bug_attachment_border_color">#8E8E93</item>
        <item name="ibg_bug_attachment_background_color">#212121</item>
        <item name="ibg_bug_thanks_subtitle_color">#9E9E9E</item>
        <item name="ibg_bug_thanks_bg_color">@drawable/ibg_bug_shape_thanks_bg_dark</item>
        <item name="ibg_bug_seperator_color">#757575</item>
        <item name="ibg_bug_color_bg_pbi">#616161</item>
        <item name="ib_core_alert_dialog_msg_color">#9E9E9E</item>
        <item name="ibg_bug_vus_header_text_color">@color/ib_bug_vus_header_text_color_dark</item>
        <item name="ibg_bug_vus_separator_color">@color/ib_bug_separator_color_dark</item>
        <item name="ibg_bug_vus_item_title_color">@color/ib_bug_vus_item_title_color_dark</item>
        <item name="ibg_bug_vus_item_subtitle_color">@color/ib_bug_vus_item_subtitle_color_dark</item>
        <item name="ibg_bug_vus_empty_state_label_color">@color/ib_bug_vus_empty_state_label_color_dark</item>
    </style>
    <style name="InstabugBugReportingLight" parent="InstabugSdkTheme.Light">
        <item name="ibg_bug_add_attachment_icon_color">#e0e0e0</item>
        <item name="ib_core_attachment_item_text_color">#212121</item>
        <item name="ibg_bug_attachment_border_color">#d1d1d1</item>
        <item name="ibg_bug_attachment_background_color">#ffffff</item>
        <item name="ibg_bug_thanks_subtitle_color">#757575</item>
        <item name="ibg_bug_thanks_bg_color">@drawable/ibg_bug_shape_thanks_bg_light</item>
        <item name="ibg_bug_seperator_color">#BCBCC2</item>
        <item name="ibg_bug_color_bg_pbi">#E0E0E0</item>
        <item name="ib_core_alert_dialog_msg_color">#757575</item>
        <item name="ibg_bug_vus_header_text_color">@color/ib_bug_vus_header_text_color_light</item>
        <item name="ibg_bug_vus_separator_color">@color/ib_bug_separator_color_light</item>
        <item name="ibg_bug_vus_item_title_color">@color/ib_bug_vus_item_title_color_light</item>
        <item name="ibg_bug_vus_item_subtitle_color">@color/ib_bug_vus_item_subtitle_color_light</item>
        <item name="ibg_bug_vus_empty_state_label_color">@color/ib_bug_vus_empty_state_label_color_light</item>

    </style>
    <style name="InstabugChatDark" parent="InstabugSdkTheme.Dark">
        <item name="ib_core_attachment_item_text_color">#FFFFFF</item>
        <item name="ib_core_alert_dialog_msg_color">#9E9E9E</item>
    </style>
    <style name="InstabugChatLight" parent="InstabugSdkTheme.Light">
        <item name="ib_core_attachment_item_text_color">#212121</item>
        <item name="ib_core_alert_dialog_msg_color">#757575</item>
    </style>
    <style name="InstabugChatsItemContainer">
        <item name="android:layout_width">match_parent</item>
    ...
    <style name="InstabugDialogAnimation">
        <item name="android:windowEnterAnimation">@android:anim/fade_in</item>
        <item name="android:windowExitAnimation">@android:anim/fade_out</item>
    </style>
    <style name="InstabugDialogButton">
        <item name="android:layout_width">wrap_content</item>
        <item name="android:layout_height">wrap_content</item>
        <item name="android:background">@android:color/transparent</item>
    </style>
    <style name="InstabugDialogButtonText" parent="@android:style/TextAppearance.Medium">
        <item name="android:textColor">?attr/instabug_dialog_button_text_color</item>
        <item name="android:layout_gravity">center</item>
        <item name="android:background">?attr/instabug_background_color</item>
    </style>
    <style name="InstabugDialogComposeMessageContainer">
        <item name="android:gravity">center_vertical</item>
        <item name="android:paddingTop">8dp</item>
    ...
    <style name="InstabugDialogContainer">
        <item name="android:layout_width">match_parent</item>
        <item name="android:layout_height">match_parent</item>
        <item name="android:background">@color/instabug_dialog_bg_color</item>
        <item name="android:clickable">true</item>
    </style>
    <style name="InstabugDialogItemContainer">
        <item name="android:layout_width">match_parent</item>
        <item name="android:layout_height">wrap_content</item>
    ...
    <style name="InstabugDialogItemDescription" parent="InstabugBaseText">
        <item name="android:textSize">@dimen/ib_core_text_size_small</item>
        <item name="android:textColor">?attr/ib_core_color_dialog_item_description</item>
        <item name="android:maxLines">4</item>
        <item name="android:ellipsize">end</item>
    </style>
    <style name="InstabugDialogItemText" parent="InstabugBaseText">
        <item name="android:textSize">@dimen/instabug_normal_text_size</item>
        <item name="android:textColor">?attr/instabug_dialog_item_text_color</item>
        <item name="android:maxLines">3</item>
        <item name="android:ellipsize">end</item>
    </style>
    <style name="InstabugDialogStyle" parent="Theme.AppCompat.Light.Dialog.Alert">
        <item name="android:textColor">?attr/ib_core_attachment_item_text_color</item>
        <item name="android:textColorPrimary">?attr/ib_core_alert_dialog_msg_color</item>
        <item name="android:background">?attr/instabug_background_color</item>
    </style>
    <style name="InstabugDialogToolbarContainer" parent="InstabugBaseToolbarContainer">
        <item name="android:background">?attr/instabug_background_color</item>
        <item name="android:paddingLeft">16dp</item>
        <item name="android:paddingRight">16dp</item>
    </style>
    <style name="InstabugEditTextStyle">
        <item name="android:layout_height">wrap_content</item>
        <item name="android:layout_width">match_parent</item>
        <item name="android:background">?attr/instabug_background_color</item>
        <item name="android:gravity">start</item>
    ...
    <style name="InstabugImageButton">
        <item name="android:layout_width">wrap_content</item>
        <item name="android:layout_height">wrap_content</item>
        <item name="android:scaleType">fitCenter</item>
        <item name="android:background">@null</item>
    </style>
    <style name="InstabugNotificationCountIcon">
        <item name="android:gravity">center</item>
        <item name="android:textColor">#FFFFFF</item>
    </style>
    <style name="InstabugReproStepsDisclaimerTextStyle">
        <item name="android:layout_height">wrap_content</item>
        <item name="android:layout_width">match_parent</item>
        <item name="android:background">?attr/instabug_background_color</item>
        <item name="android:gravity">start</item>
        <item name="android:paddingLeft">@dimen/ib_core_dialog_item_margin_right</item>
        <item name="android:paddingRight">@dimen/ib_core_dialog_item_margin_right</item>
    </style>
    <style name="InstabugReproStepsEmptyViewTextStyle">
        <item name="android:layout_height">72dp</item>
        <item name="android:layout_width">match_parent</item>
        <item name="android:layout_centerHorizontal">true</item>
        <item name="android:textSize">@dimen/instabug_question_text_size</item>
        <item name="android:layout_margin">@dimen/ib_core_padding_xsmall</item>
        <item name="android:layout_marginLeft">@dimen/ib_core_padding_xsmall</item>
        <item name="android:layout_marginRight">@dimen/ib_core_padding_xsmall</item>
        <item name="android:padding">@dimen/instabug_dialog_container_padding</item>
        <item name="android:gravity">center</item>
        <item name="android:textAlignment">center</item>
    </style>
    <style name="InstabugReproStepsListHeaderTextStyle">
        <item name="android:layout_height">wrap_content</item>
        <item name="android:layout_width">match_parent</item>
        <item name="android:background">?attr/instabug_background_color</item>
        <item name="android:gravity">start</item>
        ...
        <item name="android:padding">@dimen/ib_core_dialog_item_margin_left</item>
    </style>
    <style name="InstabugReproStepsListItemSubtitleStyle">
        <item name="android:gravity">start</item>
        <item name="android:textSize">@dimen/instabug_normal_text_size</item>
        <item name="android:ellipsize">end</item>
        <item name="android:maxLines">2</item>
    </style>
    <style name="InstabugReproStepsListItemTitleStyle">
        <item name="android:gravity">start</item>
        <item name="android:textSize">16sp</item>
        <item name="android:textStyle">bold</item>
    </style>
    <style name="InstabugResizableText" parent="InstabugBaseText">
        <item name="autoSizeTextType">uniform</item>
        <item name="autoSizeStepGranularity">1sp</item>
        <item name="autoSizeMinTextSize">8sp</item>
    </style>
    <style name="InstabugSdkTheme" parent="Theme.AppCompat.NoActionBar">
        <item name="android:windowNoTitle">true</item>
        <item name="android:windowContentOverlay">@null</item>
        <item name="android:windowIsTranslucent">false</item>
        <item name="android:windowBackground">@android:color/transparent</item>
    </style>
    <style name="InstabugSdkTheme.Base.Dark" parent="@android:style/Theme">
        <item name="android:editTextStyle">@android:style/Widget.EditText</item>
    </style>
    <style name="InstabugSdkTheme.Base.Light" parent="@android:style/Theme.Light">
        <item name="android:editTextStyle">@android:style/Widget.EditText</item>
    </style>
    <style name="InstabugSdkTheme.Dark" parent="InstabugSdkTheme.Base.Dark">
        <item name="android:windowNoTitle">true</item>
        <item name="android:windowIsTranslucent">true</item>
        <item name="android:windowContentOverlay">@null</item>
        <item name="android:windowBackground">@android:color/transparent</item>'

        <item name="instabug_primary_color">#252525</item>
        <item name="instabug_theme_tinting_color">@color/instabug_theme_tinting_color_dark</item>
        <item name="instabug_theme_hint_text_color">@color/instabug_dark_theme_hint_text_color
        </item>
        <item name="instabug_foreground_color">#ffffff</item>
        <item name="instabug_background_color">#363636</item>
        <item name="instabug_divider_color">#575757</item>

        <item name="instabug_message_sender_text_color">#EBEBEB</item>
        <item name="instabug_message_snippet_text_color">#D0D0D0</item>
        <item name="instabug_message_date_text_color">#B4B4B4</item>
        <item name="instabug_unread_message_background_color">#313131</item>
        <item name="instabug_sent_message_text_color">?attr/instabug_foreground_color</item>
        <item name="instabug_received_message_text_color">?attr/instabug_background_color</item>

        <item name="instabug_dialog_item_text_color">#ffffff</item>
        <item name="ib_core_color_dialog_item_description">#B6B6B6</item>
        <item name="instabug_survey_edittext_color">#FFFFFF</item>
        <item name="instabug_dialog_button_text_color">#ffffff</item>
        <item name="instabug_survey_welcome_title_color">#C7C7C7</item>
        <item name="instabug_survey_welcome_msg_color">#C7C7C7</item>
        <item name="instabug_survey_welcome_dismiss_txt_color">#C7C7C7</item>

        <item name="instabug_divider">@drawable/ibg_core_bg_divider_list_dark</item>
        <item name="instabug_item_border">@drawable/ibg_bg_border_dark</item>
        <item name="instabug_survey_dialog_header_transition">
            @drawable/ibg_core_transition_from_default_bg_to_default_bg_with_thin_bottom_gray_stroke_dark
        </item>
        <item name="instabug_survey_dialog_footer_transition">
            @drawable/ibg_core_transition_from_default_bg_to_default_bg_with_thin_top_gray_stroke_dark
        </item>

        <item name="instabug_attachment_bg_icon_color">@android:color/white</item>
        <item name="ib_annotation_color_picker_bg_color">#424242</item>

        <item name="instabug_fr_pbi_footer_text_color">@android:color/white</item>
        <item name="instabug_fr_text_color">#CCCCCC</item>

        <item name="ib_core_attr_onboarding_color_title">#FFFFFF</item>
        <item name="ib_core_attr_onboarding_color_sub_title">#9E9E9E</item>
    </style>
    <style name="InstabugSdkTheme.Light" parent="InstabugSdkTheme.Base.Light">
        <item name="android:windowNoTitle">true</item>
        <item name="android:windowIsTranslucent">true</item>
        <item name="android:windowContentOverlay">@null</item>
        <item name="android:windowBackground">@android:color/transparent</item>

        <item name="instabug_primary_color">#eceff1</item>
        <item name="instabug_theme_tinting_color">@color/instabug_theme_tinting_color_light</item>
        <item name="instabug_theme_hint_text_color">@color/instabug_light_theme_hint_text_color
        </item>
        <item name="instabug_foreground_color">#000000</item>
        <item name="instabug_background_color">#ffffff</item>
        <item name="instabug_divider_color">#ececec</item>

        <item name="instabug_message_sender_text_color">#000000</item>
        <item name="instabug_message_snippet_text_color">#737373</item>
        <item name="instabug_message_date_text_color">#9A9A9A</item>
        <item name="instabug_unread_message_background_color">#F9F9F9</item>
        <item name="instabug_sent_message_text_color">?attr/instabug_background_color</item>
        <item name="instabug_received_message_text_color">?attr/instabug_foreground_color</item>

        <item name="instabug_dialog_item_text_color">#DE212121</item>
        <item name="ib_core_color_dialog_item_description">#797979</item>
        <item name="instabug_survey_edittext_color">#000000</item>
        <item name="instabug_dialog_button_text_color">#2F8BF7</item>
        <item name="instabug_survey_welcome_title_color">#535353</item>
        <item name="instabug_survey_welcome_msg_color">#4C4C4C</item>
        <item name="instabug_survey_welcome_dismiss_txt_color">#898989</item>

        <item name="instabug_divider">@drawable/ibg_core_bg_divider_list_light</item>
        <item name="instabug_item_border">@drawable/ibg_core_bg_border_light</item>
        <item name="instabug_survey_dialog_header_transition">
            @drawable/ibg_core_transition_from_default_bg_to_default_bg_with_thin_bottom_gray_stroke_light
        </item>
        <item name="instabug_survey_dialog_footer_transition">
            @drawable/ibg_core_transition_from_default_bg_to_default_bg_with_thin_top_gray_stroke_light
        </item>

        <item name="instabug_attachment_bg_icon_color">@android:color/black</item>
        <item name="ib_annotation_color_picker_bg_color">#F1F1F1</item>

        <item name="instabug_fr_pbi_footer_text_color">#525E6D</item>
        <item name="instabug_fr_text_color">#333333</item>

        <item name="ib_core_attr_onboarding_color_title">#424242</item>
        <item name="ib_core_attr_onboarding_color_sub_title">#757575</item>
    </style>
    <style name="InstabugSurveyDark" parent="InstabugSdkTheme.Dark">
        <item name="survey_container_bg">@drawable/ibg_survey_container_bg_dark</item>
        <item name="survey_edittext_background">@drawable/ibg_survey_edittext_dark</item>
        <item name="instabug_survey_mcq_unselected_bg">#4D4D4D</item>
        <item name="instabug_survey_mcq_text_color">#AEAEAE</item>
        <item name="instabug_survey_mcq_text_color_selected">#FFFFFF</item>
        <item name="instabug_survey_question_color">@color/survey_txt_color_dark</item>
        <item name="instabug_survey_mcq_radio_icon_color">@color/survey_mcq_unselected_dark</item>
        <item name="survey_nps_circles_container_background">@color/nps_circles_rect_background_dark</item>
        <item name="survey_nps_circles_container_border_background">@color/nps_circles_rect_border_dark</item>
        <item name="survey_nps_circles_color">@color/nps_circles_dark</item>
        <item name="survey_nps_numbers_color">@color/nps_numbers_dark</item>
        <item name="survey_nps_background_color">@color/nps_background_dark</item>
        <item name="survey_welcome_subtitle_color">@color/welcome_screen_subtitle_dark</item>
        <item name="ib_core_alert_dialog_msg_color">#9E9E9E</item>
    </style>
    <style name="InstabugSurveyDialogQuestion" parent="InstabugResizableText">
        <item name="android:textSize">@dimen/survey_question_title</item>
        <item name="android:textColor">?attr/instabug_survey_question_color</item>
        <item name="android:gravity">start</item>
        <item name="android:textStyle">normal</item>
        <item name="android:lineSpacingExtra">6dp</item>
        <item name="android:layout_marginRight">@dimen/survey_text_end_margin</item>
        <item name="android:layout_marginLeft">@dimen/instabug_dialog_container_padding</item>
        <item name="android:layout_marginTop">@dimen/survey_question_top_margin</item>
        <item name="android:background">?attr/instabug_survey_dialog_header_transition</item>
        <item name="android:ellipsize">none</item>
        <item name="android:maxLines">5</item>

        <item name="autoSizeMaxTextSize">@dimen/survey_question_title</item>
    </style>
    <style name="InstabugSurveyEditText">
        <item name="android:layout_width">match_parent</item>
        <item name="android:layout_height">wrap_content</item>
        <item name="android:layout_marginLeft">@dimen/instabug_dialog_container_padding</item>
        <item name="android:layout_marginRight">@dimen/instabug_dialog_container_padding</item>
        <item name="android:layout_marginTop">@dimen/survey_edittext_top_margin</item>
        <item name="android:background">?attr/survey_edittext_background</item>
        <item name="android:minHeight">60dp</item>
        <item name="android:gravity">start</item>
        <item name="android:hint">@string/instabug_str_hint_enter_your_answer</item>
        <item name="android:inputType">textAutoCorrect|textMultiLine</item>
        <item name="android:paddingBottom">8dp</item>
        <item name="android:paddingLeft">@dimen/instabug_container_padding</item>
        <item name="android:paddingRight">@dimen/instabug_container_padding</item>
        <item name="android:paddingTop">8dp</item>
        <item name="android:textColor">?attr/instabug_survey_edittext_color</item>
        <item name="android:textSize">15sp</item>
    </style>
    <style name="InstabugSurveyLight" parent="InstabugSdkTheme.Light">
        <item name="survey_container_bg">@drawable/ibg_survey_container_bg_light</item>
        <item name="survey_edittext_background">@drawable/ibg_survey_edittext_light</item>
        <item name="instabug_survey_mcq_unselected_bg">#F7F7F7</item>
        <item name="instabug_survey_mcq_text_color">#484848</item>
        <item name="instabug_survey_mcq_text_color_selected">#484848</item>
        <item name="instabug_survey_question_color">@color/survey_txt_color_light</item>
        <item name="instabug_survey_mcq_radio_icon_color">@color/survey_mcq_unselected_light</item>
        <item name="survey_nps_circles_container_background">@color/nps_circles_rect_background_light</item>
        <item name="survey_nps_circles_container_border_background">@color/nps_circles_rect_border_light</item>
        <item name="survey_nps_circles_color">@color/nps_circles_light</item>
        <item name="survey_nps_numbers_color">@color/nps_numbers_light</item>
        <item name="survey_nps_background_color">@color/nps_background_light</item>
        <item name="survey_welcome_subtitle_color">@color/welcome_screen_subtitle_light</item>
        <item name="ib_core_alert_dialog_msg_color">#757575</item>
    </style>
    <style name="InstabugSurveyThanksMessage" parent="InstabugResizableText">
        <item name="android:textSize">@dimen/survey_rate_us_subTitle_text_size</item>
        <item name="android:textColor">?attr/survey_nps_numbers_color</item>
        <item name="android:gravity">center</item>
        <item name="android:textStyle">normal</item>
        <item name="android:paddingBottom">2dp</item>
        <item name="android:layout_marginTop">@dimen/instabug_survey_pager_top_space</item>
        <item name="android:ellipsize">none</item>
        <item name="android:maxLines">4</item>

        <item name="autoSizeMaxTextSize">@dimen/survey_rate_us_subTitle_text_size</item>
    </style>
    <style name="InstabugText" parent="InstabugBaseText">
        <item name="android:textSize">@dimen/instabug_normal_text_size</item>
        <item name="android:background">?attr/instabug_background_color</item>
    </style>
    <style name="InstabugToolbarTitle" parent="@android:style/TextAppearance.Medium">
        <item name="android:fontFamily">@string/font_fontFamily_medium</item>
        <item name="android:textSize">@dimen/Instabug_text_medium</item>
        <item name="android:layout_width">wrap_content</item>
        <item name="android:layout_height">wrap_content</item>
        <item name="android:layout_gravity">center_vertical</item>
    ...
    <style name="InstabugTopDialogButton" parent="InstabugDialogButton">
        <item name="android:layout_gravity">center_vertical</item>
        <item name="android:gravity">left|start|center_vertical</item>
    ...
    <style name="InstabugTranslucentSdkTheme" parent="Theme.AppCompat.NoActionBar">
        <item name="android:windowNoTitle">true</item>
        <item name="android:windowIsTranslucent">true</item>
        <item name="android:windowContentOverlay">@null</item>
        <item name="android:windowBackground">@android:color/transparent</item>
    </style>
    <style name="InstabugUnreadMessagesCountIcon">
        <item name="android:gravity">center</item>
        <item name="android:padding">2dp</item>
        <item name="android:textColor">#FFFFFF</item>
    </style>
    ...
    <declare-styleable name="CircleImageView">
        <attr format="dimension" name="ibg_civ_border_width"/>
        <attr format="color" name="ibg_civ_border_color"/>
        <attr format="boolean" name="ibg_civ_border_overlay"/>
        <attr format="color" name="ibg_civ_fill_color"/>
    </declare-styleable>
    ...
    <declare-styleable name="ColorPickerPopUpView">
        <attr format="enum" name="view_orientation">
    ...
    <declare-styleable name="CorneredImageView">
        <attr format="dimension" name="ib_bug_cornerRadius"/>
        <attr name="ib_bug_roundedCorners">
    ...
    </attr><attr format="dimension" name="fabCustomSize"/><attr name="elevation"/><attr format="dimension" name="hoveredFocusedTranslationZ"/><attr format="dimension" name="pressedTranslationZ"/><attr format="dimension" name="borderWidth"/><attr format="boolean" name="useCompatPadding"/><attr format="dimension" name="maxImageSize"/><attr name="showMotionSpec"/><attr name="hideMotionSpec"/><attr format="color" name="instabug_fab_colorPressed"/><attr format="color" name="instabug_fab_colorDisabled"/><attr format="color" name="instabug_fab_colorNormal"/><attr format="reference" name="instabug_fab_icon"/><attr format="enum" name="instabug_fab_size">
            <enum name="normal" value="0"/>
            <enum name="mini" value="1"/>
        </attr><attr format="string" name="instabug_fab_title"/><attr format="boolean" name="instabug_fab_stroke_visible"/></declare-styleable>
    ...
    <declare-styleable name="IBDot">
        <attr format="dimension" name="ibViewPagerInactiveDiameter"/>
        <attr format="dimension" name="ibViewPagerActiveDiameter"/>
        <attr format="color" name="ibViewPagerInactiveColor"/>
        <attr format="color" name="ibViewPagerActiveColor"/>
        <attr format="integer" name="ibViewPagerTransitionDuration"/>
        <attr format="boolean" name="ibViewPagerInitiallyActive"/>
    </declare-styleable>
    <declare-styleable name="IBDotIndicator">
        <attr format="integer" name="ibViewPagerNumberOfDots"/>
        <attr format="integer" name="ibViewPagerSelectedDotIndex"/>
        <attr format="dimension" name="ibViewPagerUnselectedDotDiameter"/>
        <attr format="dimension" name="ibViewPagerSelectedDotDiameter"/>
        <attr format="color" name="ibViewPagerUnselectedDotColor"/>
        <attr format="color" name="ibViewPagerSelectedDotColor"/>
        <attr format="dimension" name="ibViewPagerSpacingBetweenDots"/>
        <attr format="integer" name="ibViewPagerDotTransitionDuration"/>
    </declare-styleable>
    <declare-styleable name="IBPercentageRelativeLayout">
        <attr format="float" name="maxHeightRatio"/>
    </declare-styleable>
    <declare-styleable name="IbFrRippleView">
        <attr format="integer" name="ib_fr_rv_alpha"/>
        <attr format="integer" name="ib_fr_rv_framerate"/>
        <attr format="integer" name="ib_fr_rv_rippleDuration"/>
        <attr format="integer" name="ib_fr_rv_zoomDuration"/>
        <attr format="color" name="ib_fr_rv_color"/>
        <attr format="boolean" name="ib_fr_rv_centered"/>
        <attr format="enum" name="ib_fr_rv_type">
            <enum name="simpleRipple" value="0"/>
            <enum name="doubleRipple" value="1"/>
            <enum name="rectangle" value="2"/>
        </attr>
        <attr format="dimension" name="ib_fr_rv_ripplePadding"/>
        <attr format="boolean" name="ib_fr_rv_zoom"/>
        <attr format="float" name="ib_fr_rv_zoomScale"/>
    ...
    <declare-styleable name="IconView">
        ...
        <attr format="enum" name="instabug_icon">
            <enum name="instabug" value="0"/>
            ...
            <enum name="capture_video" value="7"/>
            <enum name="close" value="8"/>
            <enum name="erase" value="9"/>
            <enum name="feedback" value="10"/>
            <enum name="floating_bubble" value="11"/>
            <enum name="next" value="12"/>
            <enum name="pause" value="13"/>
            <enum name="photo_library" value="14"/>
            <enum name="play" value="15"/>
            <enum name="plus_attach" value="16"/>
            <enum name="plus" value="17"/>
            <enum name="send" value="18"/>
            <enum name="stop" value="19"/>
            <enum name="talk_to_us" value="20"/>
            <enum name="tick" value="21"/>
            <enum name="blur" value="22"/>
            <enum name="brush" value="23"/>
            <enum name="magnify" value="24"/>
            <enum name="undo" value="25"/>
            <enum name="survey" value="26"/>
        </attr>
    </declare-styleable>
    ...
    <declare-styleable name="NpsView">
        <attr format="integer" name="nps_count"/>
        <attr format="dimension" name="nps_num_text_size"/>
        <attr format="dimension" name="nps_selected_num_text_size"/>
        <attr format="dimension" name="nps_selected_view_edge_size"/>
        <attr format="dimension" name="nps_selected_rect_size"/>
        <attr format="dimension" name="nps_rect_corners_radius"/>
    </declare-styleable>

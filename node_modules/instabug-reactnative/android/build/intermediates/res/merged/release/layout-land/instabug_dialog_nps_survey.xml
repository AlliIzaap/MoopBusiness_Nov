...
<RelativeLayout android:id="@+id/instabug_survey_dialog_container"
    ...
    <LinearLayout
        ...
        <RelativeLayout
            ...
            <RelativeLayout
                android:id="@+id/survey_nps_question_header"
                android:layout_width="match_parent"
                android:layout_height="wrap_content"
            ...
            <LinearLayout
                android:layout_width="match_parent"
                android:layout_height="match_parent"
                android:layout_below="@id/survey_nps_question_header"
                ...
                <com.instabug.survey.ui.custom.NpsView
                    ...
                    app:nps_num_text_size="15sp"
                    app:nps_rect_corners_radius="10dp"
                    app:nps_selected_num_text_size="26sp"
                    app:nps_selected_rect_size="@dimen/survey_nps_selected_rect_size"
                    app:nps_selected_view_edge_size="11dp" />

                <RelativeLayout
                    android:id="@+id/survey_nps_text"
                    android:layout_width="match_parent"
                    android:layout_height="wrap_content">

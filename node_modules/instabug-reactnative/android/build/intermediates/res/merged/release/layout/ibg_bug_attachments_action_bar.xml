...
<LinearLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <LinearLayout
        ...
        <ImageView
            ...
            app:srcCompat="@drawable/ibg_bug_ic_arrow_down" />
    </LinearLayout>

    <FrameLayout
        android:layout_width="match_parent"
        android:layout_height="wrap_content"
        android:background="?attr/ibg_bug_attachment_background_color">
        ...
        <LinearLayout
            ...
            <LinearLayout
                ...
                <ImageView
                    ...
                    android:layout_width="@dimen/ib_bug_attachemnt_icon_size"
                    android:layout_height="@dimen/ib_bug_attachemnt_icon_size"
                    android:gravity="center"
                    app:srcCompat="@drawable/ibg_bug_ic_attach_video" />
                ...
                <TextView
                    ...
                    android:textColor="?attr/ib_core_attachment_item_text_color"
        ...
        <LinearLayout
            ...
            <RelativeLayout
                ...
                <ImageView
                    ...
                    app:srcCompat="@drawable/ibg_bug_ic_attachment" />
                ...
                <LinearLayout
                    ...
                    <ImageView
                        ...
                        android:gravity="center"
                        app:srcCompat="@drawable/ibg_bug_ic_attach_video_2" />
                    ...
                    <ImageView
                        ...
                        android:layout_marginLeft="4dp"
                        android:layout_marginRight="4dp"
                        app:srcCompat="@drawable/ibg_bug_ic_attach_screenshot_2" />

                    <ImageView
                        android:id="@+id/ib_bug_attachment_collapsed_photo_library_icon"
                        style="@style/AttachmentIcon"
                        app:srcCompat="@drawable/ibg_bug_ic_attach_img_2" />
    ...
    <LinearLayout
        ...
        <LinearLayout
            ...
            <ImageView
                ...
                style="@style/AttachmentIcon"
                android:gravity="center"
                app:srcCompat="@drawable/ibg_bug_ic_attach_screenshot" />
    ...
    <LinearLayout
        ...
        <LinearLayout
            ...
            <ImageView
                ...
                style="@style/AttachmentIcon"
                android:gravity="center"
                app:srcCompat="@drawable/ibg_bug_ic_attach_img" />
